  ...
  return (
    ...
    <div class="hero">
      <div class="hero-text">
        ...
        <button class="btn btn-lg btn-primary border-3 mt-3">Explore now</button>
      </div>
      <div>
      ...
      <div className="user_input py-3 px-4 bg-dark d-flex justify-content-between align-items-center">
        <div className="location d-flex">
          ...
          <div className="">
            <input type="text" className="border-0 bg-dark text-white" placeholder="   Location"/>
        ...
        <div className="filter d-flex">
          ...
          <div className="">
            <input type="text" className="border-0 bg-dark text-white " placeholder="   Filter"/>
            <p className="m-0">Search by hotel name</p>
          </div>
        </div>
        <div className="search rounded-circle btn btn-primary justify-content-center align-items-center">
